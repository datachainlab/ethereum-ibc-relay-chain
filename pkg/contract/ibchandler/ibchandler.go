...
func (_Ibchandler *IbchandlerTransactor) Multicall(opts *bind.TransactOpts, data [][]byte) (*types.Transaction, error) {
	return _Ibchandler.contract.Transact(opts, "multicall", data)
}

// Multicall is a paid mutator transaction binding the contract method 0xac9650d8.
//
// Solidity: function multicall(bytes[] data) returns(bytes[] results)
func (_Ibchandler *IbchandlerSession) Multicall(data [][]byte) (*types.Transaction, error) {
	return _Ibchandler.Contract.Multicall(&_Ibchandler.TransactOpts, data)
}

// Multicall is a paid mutator transaction binding the contract method 0xac9650d8.
//
// Solidity: function multicall(bytes[] data) returns(bytes[] results)
func (_Ibchandler *IbchandlerTransactorSession) Multicall(data [][]byte) (*types.Transaction, error) {
	return _Ibchandler.Contract.Multicall(&_Ibchandler.TransactOpts, data)
}
