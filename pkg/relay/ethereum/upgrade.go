...
func (c *Chain) ProposeUpgrade(
	...
	portID string,
	channelID string,
	upgradeFields ibcchannelupgradablemodule.UpgradeFieldsData,
	timeout ibcchannelupgradablemodule.TimeoutData,
) error {
	mockApp, err := ibcchannelupgradablemodule.NewIbcchannelupgradablemodule(
		appAddr,
		c.client.Client,
	)
	if err != nil {
